...
function about_post_author_settings_page() {
	...
	<div class="about-post-author-main">
		<div class="about-post-author-body about-post-author-common">
			<h1 id="page-title"><?php print esc_attr( 'About Post Author Settings' ); ?></h1>
		...
		<div class="about-post-author-aside about-post-author-common">
			...
			<div class="author-card">
				...
				<a class="link" href="https://wordpress.org/plugins/hide-admin-navbar" target="_blank">
					<span class="dashicons dashicons-admin-plugins"></span> <b>Hide Admin Navbar</b>
				</a>
			</div>
			...
			<a class="link" href="https://www.buymeacoffee.com/mehrazmorshed" target="_blank">
				<button class="button button-primary btn"><?php print esc_attr( 'Donate To This Plugin' ); ?></button>
			</a>
		</div>
	</div>
	<?php
